...
public class Triangle {
    ...
    public double perimeter() {
      double side1 = (double)vertices[0].distanceTo(vertices[1]);
      double side2 = (double)vertices[1].distanceTo(vertices[2]);
      double side3 = (double)vertices[0].distanceTo(vertices[2]);
